...
public class TestFlyWeight {
    public static void main(String[] args) {
        ...
        yellowThinPen2.draw("Hello World Two !!");

        Pen blueThinPen = PenFactory.getThickPen("BLUE");       //created new pen
        blueThinPen.draw("Hello World !!");

        System.out.println(yellowThinPen1.hashCode()); //Should use same pen
        System.out.println(yellowThinPen2.hashCode()); //Should use same pen
